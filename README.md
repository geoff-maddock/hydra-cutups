...
This repository is a collection of tests and code written by Geoff Maddock, for use with hydra.

Hydra uses multiple framebuffers to allow dynamically mixing, compositing, and collaborating between connected 
browser-visual-streams. Coordinate and color transforms can be applied to each output via chained functions.
...
### Links
* [hydra](https://github.com/ojack/hydra): git repository for the web project
* [@hydra_patterns](https://twitter.com/hydra_patterns): for patterns folks have shared as an easy way to get started.


### Learning
* [All Functions](https://github.com/ojack/hydra/blob/master/docs/funcs.md)
* [Tutorials & Examples](https://github.com/ojack/hydra/blob/master/examples/README.md)
